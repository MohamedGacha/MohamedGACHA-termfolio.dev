...
func (m model) View() string {
	...
	case 0: // Experience
		rightPanelContent = lipgloss.JoinVertical(
			...
			"",
			titleStyle.Render("━━━ Gatewatcher ✕ Cybersecurity Engineer ━━━"),
			...
			"",
			titleStyle.Render("━━━ Etifak ✕ Backend Engineer ━━━"),
			...
			"",
			titleStyle.Render("━━━ Suez Digital Solutions ✕ Data Engineer Intern ━━━"),
